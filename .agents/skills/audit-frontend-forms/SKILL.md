...
form bugs are 60% of user-reported issues (AGENTS.md bug list — index
...
**Why**: AGENTS.md bug #8 fix — without `data-field`, scrollToError can't focus the field.
...
- `TreatmentFormPage.jsx` missing `data-field` on seller/payment → fixed by AGENTS.md bug fix #8.
