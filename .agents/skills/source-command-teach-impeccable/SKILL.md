---
name: "source-command-teach-impeccable"
...
# source-command-teach-impeccable

Use this skill when the user asks to run the migrated source command `teach-impeccable`.
