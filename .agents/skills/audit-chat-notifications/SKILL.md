...
# Pattern updated audit-all 2026-07-19: V78 migrated send.js from REST integerValue
# strings to the firebase-admin SDK plain-object write.
```
...
- `.Codex/rules/03-stack.md` Chat system section — FB echo subscription, LINE no-echo, lastMessage/displayName rules.
- `.Codex/rules/01-iron-clad.md` Rule C1 (Rule of 3) — shared helper mandate.
- `.Codex/rules/01-iron-clad.md` Rule D (Continuous Improvement) — this skill is the invariant-gate that fulfils D after the 2026-04-22 fix.
