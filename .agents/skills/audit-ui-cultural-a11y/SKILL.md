...
**Why**: AGENTS.md rule 4 — สีแดง = คนตาย in Thai culture.
...
### UC2 — No gold/yellow
**Why**: AGENTS.md rule 4 — user dislikes.
...
**Why**: feedback_date_picker_rule.md + AGENTS.md rule 4.
...
**Why**: AGENTS.md brand — แดง ดำ ขาว ไฟ + LINE green.
