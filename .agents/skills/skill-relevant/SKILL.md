...
for skill_file in .Codex/skills/*/SKILL.md; do
...
| `.Codex/rules/**` | audit-rules |
| `.Codex/skills/**` | audit-rules (indirectly — skill quality) |
...
- `/audit-rules` — if the edit touched `.Codex/rules/`
