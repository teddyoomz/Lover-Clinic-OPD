# Checkpoint 2026-07-18 — TFP Entry SWR cold-start fix (AV208) — SHIPPED + DEPLOYED LIVE

> DEPLOYED 2026-07-18 EOD: vercel `lover-clinic-4hr8of3tr` aliased lover-clinic-app.vercel.app (200);
> rules UNCHANGED → vercel-only. Post-deploy L1 probe บน LIVE prod: chip + cache paint + 18KB delta @400kbps ✓.
...
## Next Todo
1. ~~Deploy~~ ✓ DONE (2026-07-18 EOD, vercel-only, LIVE probe green) → **user L1 บนเครื่องคลินิกช้าจริง**
   (เปิด TFP ซ้ำๆ ควร ≤1-2s + chip ⟳ แว๊บ + เทียบ 5G) + มือถือ. ห้ามล้าง cache เป็น folk-fix.
