...
describe('filler defaults + thinner dashed', () => {
  ...
  it('green dashed "after" outline is theme-tuned (afterStrokeColor + afterStrokeW), no 1.7 remains', () => {
    expect((g2d.match(/stroke=\{afterStrokeColor\} strokeWidth=\{afterStrokeW\} strokeDasharray="7 4"/g) || []).length).toBe(2);
