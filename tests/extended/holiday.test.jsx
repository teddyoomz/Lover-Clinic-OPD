...
vi.mock('../../src/lib/backendClient.js', () => ({
  ...
  // 2026-07-19 repoint: Phase BSA Task 8 wired HolidaysTab through
  // useBranchAwareListener → the listener now receives (opts, onChange,
  // onError) where opts = {branchId} injected by the hook — NOT
  // (onChange, onError).
