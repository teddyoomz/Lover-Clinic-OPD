...
//
// All UI3.* V40-locked tests REMOVED 2026-05-20 (were .skip tombstones — the
// retired V40 modal no longer exists). The "modal opens with bucket list" smoke
// is preserved at UI2.5 above; full flow coverage lives in the
// selective-make-fresh files listed above.
