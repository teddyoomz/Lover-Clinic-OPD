            ...
            <div className="p-5">
              ...
              <div className="rounded-xl p-4 mb-4 text-left relative overflow-hidden" style={{ background: isDark ? 'rgba(249,115,22,0.06)' : 'rgba(249,115,22,0.05)', border: `1px solid ${isDark ? 'rgba(249,115,22,0.15)' : 'rgba(249,115,22,0.2)'}` }}>
                ...
                <p className="text-[15px] leading-[1.7] font-bold pl-2.5" style={{ color: isDark ? '#f5f5f4' : '#1e293b' }}>
                  {language === 'en'
                    ? 'To receive 📋 appointment confirmations, 💊 prescriptions, 🩺 treatment updates, and 📞 direct communication from our medical team — please add our LINE Official Account now!'
                    : 'เพื่อรับ 📋 การยืนยันนัดหมาย 💊 ใบสั่งยา 🩺 ผลการรักษา และ 📞 การติดต่อจากทีมแพทย์โดยตรง — กรุณาเพิ่มเพื่อนกับเราไว้ล่วงหน้า'}
                </p>
              </div>
