...
export default function ProductFormModal({ product, onClose, onSaved, clinicSettings }) {
  ...
  return (
    ...
    >
      ...
      {/* Phase 29.22 (2026-05-14) — Recall presets moved out of master-data.
          Recall durations are now managed via the Recall tab's "จัดการเคส"
          sub-pill (be_recall_cases universal collection). No per-product
          recall fields here anymore (legacy followUpAfterDays / followUpReason
          / recallAfterDays / recallReason stripped). */}
    </MarketingFormShell>
  );
}
