...
export default function ProductFormModal({ product, onClose, onSaved, clinicSettings }) {
  ...
  return (
    ...
    >
      ...
      {/* Phase 29 (2026-05-14) — Recall settings (optional). When set, these
          values auto-suggest in the recall modal when admin creates a recall
          for a customer who used this product. All 4 fields are independently
          optional — admin can fill in any combination or none. */}
      <div className="rounded-xl border border-[var(--bd)] p-3" data-field="recall-settings">
        ...
        <p className="text-[10px] text-[var(--tx-muted)] italic mb-3">
          Auto-suggest จำนวนวันที่ต้องโทรหาลูกค้าหลังใช้สินค้านี้
        </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <div data-field="followUpAfterDays">
              <input type="number" min="0" max="3650"
                placeholder="กี่วันหลังการใช้ (เช่น 1-3)"
