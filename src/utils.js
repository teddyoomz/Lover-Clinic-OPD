...
export const NATIONALITY_COUNTRIES = [
  ...
  'แองโกลา (Angola)','แอนติกาและบาร์บูดา (Antigua and Barbuda)','อาร์เจนตินา (Argentina)',
  'อาร์เมเนีย (Armenia)','ออสเตรเลีย (Australia)','ออสเตรีย (Austria)',
  'อาเซอร์ไบจาน (Azerbaijan)','บาฮามาส (Bahamas)','บาห์เรน (Bahrain)',
  'บังกลาเทศ (Bangladesh)','บาร์เบโดส (Barbados)','เบลารุส (Belarus)',
  'เบลเยียม (Belgium)','เบลีซ (Belize)','เบนิน (Benin)','ภูฏาน (Bhutan)',
  'โบลิเวีย (Bolivia)','บอสเนียและเฮอร์เซโกวีนา (Bosnia and Herzegovina)',
  'บอตสวานา (Botswana)','บราซิล (Brazil)','บรูไน (Brunei)','บัลแกเรีย (Bulgaria)',
  'บูร์กินาฟาโซ (Burkina Faso)','บุรุนดี (Burundi)','กาบูเวร์ดี (Cabo Verde)',
  'กัมพูชา (Cambodia)','แคเมอรูน (Cameroon)','แคนาดา (Canada)',
  'สาธารณรัฐแอฟริกากลาง (Central African Republic)','ชาด (Chad)','ชิลี (Chile)',
  'จีน (China)','โคลอมเบีย (Colombia)','คอโมโรส (Comoros)',
  'สาธารณรัฐคองโก (Congo)','คอสตาริกา (Costa Rica)','โครเอเชีย (Croatia)',
  'คิวบา (Cuba)','ไซปรัส (Cyprus)','เช็ก (Czech Republic)',
  'เดนมาร์ก (Denmark)','จิบูตี (Djibouti)','โดมินิกา (Dominica)',
  'สาธารณรัฐโดมินิกัน (Dominican Republic)','เอกวาดอร์ (Ecuador)','อียิปต์ (Egypt)',
  'เอลซัลวาดอร์ (El Salvador)','อิเควทอเรียลกินี (Equatorial Guinea)',
  'เอริเทรีย (Eritrea)','เอสโตเนีย (Estonia)','เอสวาตีนี (Eswatini)',
  'เอธิโอเปีย (Ethiopia)','ฟิจิ (Fiji)','ฟินแลนด์ (Finland)','ฝรั่งเศส (France)',
  'กาบอง (Gabon)','แกมเบีย (Gambia)','จอร์เจีย (Georgia)','เยอรมนี (Germany)',
  'กานา (Ghana)','กรีซ (Greece)','เกรเนดา (Grenada)','กัวเตมาลา (Guatemala)',
  'กินี (Guinea)','กินี-บิสเซา (Guinea-Bissau)','กายอานา (Guyana)','เฮติ (Haiti)',
  ...
  'จอร์แดน (Jordan)','คาซัคสถาน (Kazakhstan)','เคนยา (Kenya)','คิริบาส (Kiribati)',
  'เกาหลีเหนือ (North Korea)','เกาหลีใต้ (South Korea)','คูเวต (Kuwait)',
  'คีร์กีซสถาน (Kyrgyzstan)','ลาว (Laos)','ลัตเวีย (Latvia)','เลบานอน (Lebanon)',
  'เลโซโท (Lesotho)','ไลบีเรีย (Liberia)','ลิเบีย (Libya)',
  'ลิกเตนสไตน์ (Liechtenstein)','ลิทัวเนีย (Lithuania)','ลักเซมเบิร์ก (Luxembourg)',
  'มาดากัสการ์ (Madagascar)','มาลาวี (Malawi)','มาเลเซีย (Malaysia)',
  'มัลดีฟส์ (Maldives)','มาลี (Mali)','มอลตา (Malta)',
  'หมู่เกาะมาร์แชลล์ (Marshall Islands)','มอริเตเนีย (Mauritania)',
  'มอริเชียส (Mauritius)','เม็กซิโก (Mexico)','ไมโครนีเซีย (Micronesia)',
  'มอลโดวา (Moldova)','โมนาโก (Monaco)','มองโกเลีย (Mongolia)',
  'มอนเตเนโกร (Montenegro)','โมร็อกโก (Morocco)','โมซัมบิก (Mozambique)',
  'เมียนมา (Myanmar)','นามิเบีย (Namibia)','นาอูรู (Nauru)','เนปาล (Nepal)',
  'เนเธอร์แลนด์ (Netherlands)','นิวซีแลนด์ (New Zealand)','นิการากัว (Nicaragua)',
  'ไนเจอร์ (Niger)','ไนจีเรีย (Nigeria)','มาซิโดเนียเหนือ (North Macedonia)',
  'นอร์เวย์ (Norway)','โอมาน (Oman)','ปากีสถาน (Pakistan)','ปาเลา (Palau)',
  'ปานามา (Panama)','ปาปัวนิวกินี (Papua New Guinea)','ปารากวัย (Paraguay)',
  ...
  'เซนต์วินเซนต์ฯ (Saint Vincent)','ซามัว (Samoa)','ซานมารีโน (San Marino)',
  'เซาตูเมและปรินซิปี (Sao Tome and Principe)','ซาอุดีอาระเบีย (Saudi Arabia)',
  'เซเนกัล (Senegal)','เซอร์เบีย (Serbia)','เซเชลส์ (Seychelles)',
  'เซียร์ราลีโอน (Sierra Leone)','สิงคโปร์ (Singapore)','สโลวาเกีย (Slovakia)',
  'สโลวีเนีย (Slovenia)','หมู่เกาะโซโลมอน (Solomon Islands)','โซมาเลีย (Somalia)',
  'แอฟริกาใต้ (South Africa)','ซูดานใต้ (South Sudan)','สเปน (Spain)',
  'ศรีลังกา (Sri Lanka)','ซูดาน (Sudan)','ซูรินาม (Suriname)',
  'สวีเดน (Sweden)','สวิตเซอร์แลนด์ (Switzerland)','ซีเรีย (Syria)',
  'ไต้หวัน (Taiwan)','ทาจิกิสถาน (Tajikistan)','แทนซาเนีย (Tanzania)',
  'ตุรกี (Turkey)','เติร์กเมนิสถาน (Turkmenistan)','ตูวาลู (Tuvalu)',
  'ยูกันดา (Uganda)','ยูเครน (Ukraine)','สหรัฐอาหรับเอมิเรตส์ (UAE)',
  'สหราชอาณาจักร (United Kingdom)','สหรัฐอเมริกา (USA)',
  'อุรุกวัย (Uruguay)','อุซเบกิสถาน (Uzbekistan)','วานูอาตู (Vanuatu)',
  'นครรัฐวาติกัน (Vatican City)','เวเนซุเอลา (Venezuela)','เวียดนาม (Vietnam)',
  'เยเมน (Yemen)','แซมเบีย (Zambia)','ซิมบับเว (Zimbabwe)',
  'ฮ่องกง (Hong Kong)','มาเก๊า (Macau)','ปาเลสไตน์ (Palestine)',
];
