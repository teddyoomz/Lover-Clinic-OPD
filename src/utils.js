...
// สัญชาติ — ประเทศที่พบบ่อยขึ้นก่อน, value ส่งให้ ProClinic match by English name in ()
export const NATIONALITY_COUNTRIES = [
  'เมียนมาร์ (Myanmar)','ลาว (Laos)','กัมพูชา (Cambodia)','เวียดนาม (Vietnam)',
  'จีน (China)','ญี่ปุ่น (Japan)','เกาหลีใต้ (South Korea)',
  'อินเดีย (India)','ฟิลิปปินส์ (Philippines)','อินโดนีเซีย (Indonesia)',
  'มาเลเซีย (Malaysia)','สิงคโปร์ (Singapore)',
  'สหรัฐอเมริกา (United States)','สหราชอาณาจักร (United Kingdom)',
  'เยอรมนี (Germany)','ฝรั่งเศส (France)','ออสเตรเลีย (Australia)',
  'รัสเซีย (Russia)','แคนาดา (Canada)','สวีเดน (Sweden)',
  'นอร์เวย์ (Norway)','เดนมาร์ก (Denmark)','เนเธอร์แลนด์ (Netherlands)',
  'สวิตเซอร์แลนด์ (Switzerland)','อิตาลี (Italy)','สเปน (Spain)',
  'บราซิล (Brazil)','ซาอุดีอาระเบีย (Saudi Arabia)',
  'สหรัฐอาหรับเอมิเรตส์ (United Arab Emirates)',
  'อิสราเอล (Israel)','แอฟริกาใต้ (South Africa)','นิวซีแลนด์ (New Zealand)',
];
