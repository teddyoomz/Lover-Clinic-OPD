...
### Session 2026-07-18 — TFP Entry SWR cold-start fix (AV208) — SHIPPED local, NOT deployed

master = 10 commits ahead of prod (rules UNCHANGED → deploy = vercel-only). full vitest **17,631/17,631 · 0 fail**; build clean; Rule Q L1 adversarial 5/5 on real prod.
...
- Next: user "deploy" (vercel-only) → PROD probes re-run → **user L1 เครื่องคลินิกช้าจริง + มือถือ**.
  Backlog: TFP resilient-timeout (half-dead parity) · positional-rowId watchlist · doctorName-filtered edge.
