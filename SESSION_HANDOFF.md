...
- **Date last updated**: 2026-05-21 EOD+1 LATE+1 — Tablet Chart more-tools: ALL 3 symptoms FIXED (init-once + save) + verified via full-relay Playwright e2e; storage.rules json fix awaits deploy
- **Master**: `6f7895e4` (clean, pushed). **Prod**: `d750c725` — ratio fix LIVE. **more-tools + 2 post-ship fixes = ~16 commits ahead, NOT deployed.** Storage CORS live. V106 + V108 also live.
- **Tests**: full vitest **GREEN (13929/0)** · build clean · **full-relay Playwright e2e GREEN on real prod** (template 205px + pen 52px + rect 52→164px + save 123KB PNG→PC). +RC1-RC5 + AV103.
