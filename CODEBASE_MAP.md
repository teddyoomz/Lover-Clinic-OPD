...
- Tests: Scenario 21 +6 (S21.11-S21.16) — after-pick / not-picked / qty-multiplier / non-pick-at-treatment pass-through / `!alreadyResolved` guard grep / both-call-site wiring grep.
