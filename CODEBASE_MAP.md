...
- Fields: `months`, `doctorDays`, `closedDays`, `bookedSlots`, `manualBlockedSlots`, `clinicOpenTime/CloseTime`, `clinicOpenTimeWeekend/CloseTimeWeekend`, `slotDurationMins`, `noDoctorRequired`, `enabled`, `createdAt`
...
- `handleGenScheduleLink()` — sync all months + create schedule doc
